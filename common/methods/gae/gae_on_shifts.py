...
print '... loading data'
train_features_x = numpy.load('./shiftsuniform_x.npy').astype(theano.config.floatX)
train_features_y = numpy.load('./shiftsuniform_y.npy').astype(theano.config.floatX)
